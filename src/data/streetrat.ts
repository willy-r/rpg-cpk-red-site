...
export const streetratPackages: StreetratPackage[] = [
  // ── ROCKERBOY ─────────────────────────────────────────────────────────────
  {
    ...
    cyware: [
      ...
      { name: "Chemskin",           namePtBr: "Pele Química",       description: "Pigmentos infundidos na pele — cor permanente. +2 em Cuidados Pessoais (com Cabelo Tech).", humanityLoss: 0 },
      { name: "Cyberaudio Suite",   namePtBr: "Suite Cyberaudio",   description: "Ouvido cibernético com 3 slots de opções.", humanityLoss: 7 },
      { name: "Techhair",           namePtBr: "Cabelo Tech",        description: "Cabelo artificial com LEDs coloridos. +2 em Cuidados P. (com Pele Química).", humanityLoss: 0 },
    ],
    totalHumanityLoss: 9,
    startingEurobucks: 0,
  ...
  // ── SOLO ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Escudo Balístico",              category: "armor", sp: 10,       description: "Cobertura móvel com 10 HP. Interposto entre você e o ataque — o escudo absorve o dano inteiro. Ocupa uma mão. Destruído ao chegar a 0 HP.", cost: 100, icon: "🛡️", choiceGroupId: "solo-melee" },
      // Armor
    ...
    cyware: [
      ...
      { name: "Wolvers",     namePtBr: "Wolvers",     description: "Arma B. P. com 3d6 de Dano e CDT de 2.", humanityLoss: 7, choiceGroupId: "solo-speed" },
    ],
  ...
  // ── NETRUNNER ─────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Programa: Armor (DEF 4)",        category: "gear",   description: "Reduz em 4 todos os danos cerebrais que você receberia.", cost: 250, icon: "🛡️" },
      { name: "Programa: Sword (ATK 4)",        category: "gear",   description: "Faz 3d6 REZ para um Programa ICE Preto, ou 2d6 REZ para um Programa ICE Não-Preto.", cost: 250, icon: "⚔️" },
      { name: "Programa: See Ya",               category: "gear",   description: "+2 em Verificações de Pathfinder.", cost: 250, icon: "👻", choiceGroupId: "nr-prog1" },
      { name: "Programa: Eraser",               category: "gear",   description: "+2 em verificações de camuflagem.", cost: 250, icon: "🧹", choiceGroupId: "nr-prog1" },
      { name: "Programa: Vrizzbolt (ATK 3)",    category: "gear",   description: "1d6 de dano ao cérebro e reduz 1 ação NET que o inimigo pode realizar no próximo turno.", cost: 250, icon: "⚡" },
      { name: "Programa: Worm",                 category: "gear",   description: "Aumenta todas as verificações de backdoor em +2.", cost: 250, icon: "🪱" },
  ...
  // ── TECH ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Sinalizador x6",                category: "gear",   description: "Ilumina uma área de 100m por 1h.", cost: 60, icon: "🔴" },
  ...
  // ── MEDTECH ───────────────────────────────────────────────────────────────
  {
    ...
    skills: [
      ...
      { namePtBr: "Medicamentos",             linkedStat: "TECH", rank: 6, whyItMatters: "A habilidade médica central — estabilização de trauma e cirurgia de campo." },
    ...
    gear: [
      ...
      { name: "Escudo Balístico",                category: "armor", sp: 10,    description: "Cobertura móvel com 10 HP. Interposto entre você e o ataque — o escudo absorve o dano inteiro. Protege enquanto você trabalha em campo hostil.", cost: 100, icon: "🛡️" },
      ...
      { name: "Algemas",                         category: "gear",   description: "Requer BODY > 10 para quebrar.", cost: 50, icon: "⛓️" },
    ...
    cyware: [
      ...
      { name: "TeleOptics",     namePtBr: "TeleÓptica",              description: "Visão detalhada até 800m. +1 para um teste de mira.", humanityLoss: 3 },
    ],
    totalHumanityLoss: 12,
    startingEurobucks: 0,
  ...
  // ── MEDIA ─────────────────────────────────────────────────────────────────
  {
    ...
    cyware: [
      ...
      { name: "Light Tattoo",          namePtBr: "Tatuagem de Luz",      description: "Patches subérmicos que projetam tatuagens coloridas. +2 em Cuidados P. com 3 Tattoos ou mais.", humanityLoss: 0 },
    ],
  ...
  // ── EXEC ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Comunicador de Rádio x4",        category: "gear",   description: "Fone de ouvido. Alcance de 1,6km.", cost: 400, icon: "📻" },
    ...
    cyware: [
      ...
      { name: "Techhair",           namePtBr: "Cabelo Tech",             description: "Cabelo artificial com LEDs coloridos. +2 em Cuidados P. (com Pele Química).", humanityLoss: 0, choiceGroupId: "exec-fashion" },
      { name: "Cyberaudio Suite",   namePtBr: "Suite Cyberaudio",        description: "Ouvido cibernético com 3 slots de opções.", humanityLoss: 7 },
      { name: "Internal Agent",     namePtBr: "Agente Interno",          description: "Um Agente Pessoal controlado por voz.", humanityLoss: 3 },
  ...
  // ── LAWMAN ────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      // Gear
      { name: "Munição Rifle x100",             category: "gear",   description: "Cem balas de rifle.", cost: 100, icon: "📦", linkedChoice: { group: "law-primary", when: "Rifle de Assalto" } },
      { name: "Munição Espingarda x100",        category: "gear",   description: "Cem cartuchos de espingarda.", cost: 100, icon: "📦", linkedChoice: { group: "law-primary", when: "Espingarda" } },
      ...
      { name: "Escudo Balístico",               category: "armor", sp: 10,    description: "Cobertura móvel com 10 HP. Interposto entre você e o ataque — o escudo absorve o dano inteiro. Ocupa uma mão.", cost: 100, icon: "🛡️", choiceGroupId: "law-shield" },
      ...
      { name: "Algemas x2",                     category: "gear",   description: "Requer BODY > 10 para quebrar.", cost: 100, icon: "⛓️" },
      { name: "Comunicador de Rádio",           category: "gear",   description: "Fone de ouvido. Alcance de 1,6km.", cost: 100, icon: "📻" },
      { name: "Lanterna",                       category: "gear",   description: "Feixe de 100m, 10 horas. Operações noturnas e locais sem iluminação.", cost: 20, icon: "🔦" },
      { name: "Sinalizador x10",                category: "gear",   description: "Ilumina uma área de 100m por 1h.", cost: 100, icon: "🔴" },
  ...
  // ── NOMAD ─────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Comunicador de Rádio x2",            category: "gear",   description: "Fone de ouvido. Alcance de 1,6km.", cost: 200, icon: "📻" },
    ...
    cyware: [
      ...
      { name: "Wolvers",        namePtBr: "Wolvers",              description: "Arma B. P. com 3d6 de Dano e CDT de 2.", humanityLoss: 7, choiceGroupId: "nom-neural" },
    ],
    totalHumanityLoss: 14,
    startingEurobucks: 0,
