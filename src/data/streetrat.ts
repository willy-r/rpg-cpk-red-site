...
export const streetratPackages: StreetratPackage[] = [
  // ── ROCKERBOY ─────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. +2 em Guarda-roupa & Estilo com Chemskin. Transmissão ao vivo e agenda.", cost: 100, icon: "📱" },
  ...
  // ── SOLO ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Escudo Balístico",              category: "gear",               description: "Proteção adicional em combate. +4 SP contra ataques frontais.", cost: 100, icon: "🛡️", choiceGroupId: "solo-melee" },
      // Armor
      ...
      { name: "Agente Pessoal",                category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Comunicação segura, mapas e identificação de alvos.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
  ...
  // ── NETRUNNER ─────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                 category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Comunicação e suporte fora da NET.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
    ...
    cyware: [
      { name: "Neural Link",    namePtBr: "Neural Link",          description: "Sistema nervoso artificial. 5 slots. Base para cyberware neural.", humanityLoss: 7 },
      { name: "Shift Tacts",    namePtBr: "Shift Tacts",          description: "Lentes coloridas implantadas no olho — mudam de cor.", humanityLoss: 0 },
      { name: "Cybereye",       namePtBr: "Cybereye",             description: "Olho artificial com 3 slots de opções.", humanityLoss: 7 },
      { name: "MicroOptics",    namePtBr: "MicroÓptica",          description: "Microscópio ocular — 400x de aumento. Requer Cybereye.", humanityLoss: 2 },
      { name: "Skinwatch",      namePtBr: "Relogio Subdérmico",   description: "Relógio de LED implantado sob a pele.", humanityLoss: 0 },
      { name: "Tool Hand",      namePtBr: "Mão Ferramenta",       description: "Dedos com chave de fenda, chave inglesa e mini furadeira integradas.", humanityLoss: 3 },
    ],
    totalHumanityLoss: 14,
    empLoss: 2,
    startingEurobucks: 500,
  ...
  // ── TECH ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                 category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Manuais, esquemáticos e comunicação.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
    ...
    cyware: [
      { name: "Biomonitor",      namePtBr: "Biomonitor",           description: "Monitora sinais vitais. Pode vincular ao Agente.", humanityLoss: 0 },
      { name: "Cybereye",        namePtBr: "Cybereye",             description: "Olho artificial com 3 slots de opções.", humanityLoss: 7 },
      { name: "Nasal Filters",   namePtBr: "Filtros Nasais",       description: "Imune a gases tóxicos e fumaças perigosas.", humanityLoss: 2, choiceGroupId: "tech-nasal" },
      { name: "Toxin Binders",   namePtBr: "Absorvedores de Toxinas", description: "+2 em Resistir Tortura/Drogas.", humanityLoss: 2, choiceGroupId: "tech-nasal" },
      { name: "TeleOptics",      namePtBr: "TeleÓptica",           description: "Visão detalhada até 800m. +1 em Tiros Minhocados a 51m+. Requer Cybereye.", humanityLoss: 3 },
    ],
  ...
  // ── MEDTECH ───────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Escudo Balístico",                category: "gear",   description: "Protege pacientes enquanto você trabalha em ambiente hostil.", cost: 100, icon: "🛡️" },
      ...
      { name: "Agente Pessoal",                  category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Banco de dados médicos e registros.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",  category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
  ...
  // ── MEDIA ─────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                 category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Transmissão ao vivo e banco de contatos.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
    ...
    cyware: [
      { name: "Cyberaudio Suite",      namePtBr: "Suite Cyberaudio",     description: "Ouvido cibernético com 3 slots de opções.", humanityLoss: 7 },
      { name: "Amplified Hearing",     namePtBr: "Audição Amplificada",  description: "+2 em Percepção para testes envolvendo audição.", humanityLoss: 3, choiceGroupId: "media-audio" },
      { name: "Voice Stress Analyzer", namePtBr: "Analisador de Voz",    description: "+2 em Percepção Humana e Interrogatório.", humanityLoss: 3, choiceGroupId: "media-audio" },
      ...
      { name: "Hidden Holster",        namePtBr: "Coldre Escondido",     description: "Arma conceal armazenada dentro do corpo.", humanityLoss: 7 },
      { name: "Subdermal Pocket",      namePtBr: "Bolso Subdérmico",     description: "Compartimento 5cm×10cm sob a pele.", humanityLoss: 3 },
    ],
  ...
  // ── EXEC ──────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                 category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Agenda de contatos e banco de favores.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir", category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
    ...
    cyware: [
      { name: "Cyberaudio Suite",      namePtBr: "Suite Cyberaudio",     description: "Ouvido cibernético com 3 slots de opções.", humanityLoss: 7 },
      { name: "Internal Agent",        namePtBr: "Agente Interno",       description: "Agente totalmente funcional instalado internamente.", humanityLoss: 3 },
      { name: "Subdermal Pocket",      namePtBr: "Bolso Subdérmico",     description: "Compartimento 5cm×10cm sob a pele com zíper RealSkinn™.", humanityLoss: 3 },
      { name: "Voice Stress Analyzer", namePtBr: "Analisador de Voz",    description: "+2 em Percepção Humana e Interrogatório.", humanityLoss: 3, choiceGroupId: "exec-audio" },
      { name: "Amplified Hearing",     namePtBr: "Audição Amplificada",  description: "+2 em Percepção para testes de audição.", humanityLoss: 3, choiceGroupId: "exec-audio" },
    ],
    totalHumanityLoss: 12,
    empLoss: 2,
    startingEurobucks: 500,
  ...
  // ── LAWMAN ────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Escudo Balístico",               category: "gear",   description: "+4 SP contra ataques frontais em operações táticas.", cost: 100, icon: "🛡️", choiceGroupId: "law-shield" },
      ...
      { name: "Agente Pessoal",                 category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. Bancos de dados criminais e identificação.", cost: 100, icon: "📱" },
      { name: "Cama Inflável c/ Saco de Dormir",category: "gear",   description: "Colchão autoinflável com saco de dormir. Dobra em pacote de 15cm×15cm.", cost: 20, icon: "🛏️" },
    ...
    cyware: [
      { name: "Cyberaudio Suite",   namePtBr: "Suite Cyberaudio",     description: "Ouvido cibernético com 3 slots de opções.", humanityLoss: 7 },
      { name: "Internal Agent",     namePtBr: "Agente Interno",       description: "Agente totalmente funcional instalado internamente.", humanityLoss: 3 },
      { name: "Biomonitor",         namePtBr: "Biomonitor",           description: "Monitora sinais vitais. Pode vincular ao Agente.", humanityLoss: 0, choiceGroupId: "law-fashion" },
      { name: "Techhair",           namePtBr: "Cabelo Tech",          description: "Cabelo artificial com LEDs — identidade de rua.", humanityLoss: 0, choiceGroupId: "law-fashion" },
      { name: "Nasal Filters",      namePtBr: "Filtros Nasais",       description: "Imune a gases tóxicos e fumaças.", humanityLoss: 2, choiceGroupId: "law-nasal" },
      { name: "Toxin Binders",      namePtBr: "Absorvedores de Toxinas", description: "+2 em Resistir Tortura/Drogas.", humanityLoss: 2, choiceGroupId: "law-nasal" },
    ],
    totalHumanityLoss: 10,
    empLoss: 2,
    startingEurobucks: 500,
  ...
  // ── FIXER ─────────────────────────────────────────────────────────────────
  {
    ...
    cyware: [
      { name: "Neural Link",    namePtBr: "Neural Link",          description: "Sistema nervoso artificial. 5 slots. Base para cyberware neural.", humanityLoss: 7 },
      { name: "Interface Plugs",namePtBr: "Plugues de Interface", description: "Conectores para máquinas e veículos. Requer Neural Link.", humanityLoss: 7, choiceGroupId: "fix-neural" },
      { name: "Wolvers",        namePtBr: "Wolvers",              description: "Garras retráteis nos nós dos dedos. Arma Pesada de Melee. Concealable.", humanityLoss: 7, choiceGroupId: "fix-neural" },
    ],
  ...
  // ── NOMAD ─────────────────────────────────────────────────────────────────
  {
    ...
    gear: [
      ...
      { name: "Agente Pessoal",                     category: "gear",   description: "Smartphone com IA. +2 em Pesquisa em Biblioteca. GPS, clima e comunicação.", cost: 100, icon: "📱" },
